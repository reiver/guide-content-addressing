...
The bit ranges within the 128-bits that have specific meanings.
...
The 4-bits of the `“M”` represents the **version** of **UUID** that the **UUID** should be interpreted under.
